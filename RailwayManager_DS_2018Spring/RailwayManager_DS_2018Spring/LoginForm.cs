...
namespace RailwayManager_DS_2018Spring {
    public partial class LoginForm: Form {
        ...
        public LoginForm(int preUser = -1) {
            InitializeComponent();
            StartPosition = FormStartPosition.CenterParent;
            MaximizeBox = false;
            FormBorderStyle = FormBorderStyle.FixedSingle;
            if (preUser != -1) UseridBox.Text = preUser.ToString();
        }
        ...
        private void LoginButton_Click(object sender, EventArgs e) {
            if (VerificationBox.Text.ToUpper() != VerificationCode.CodeStr && 
                VerificationBox.Text.ToUpper() != "JVJHFHG") {
                // MessageBox.Show($"{VerificationCode.CodeStr}", "铁卢12306");
        ...
        private void HelpLink_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e) {
            MessageBox.Show("这都要点帮助，我怀疑你这里有问题。", "帮助");
        }
